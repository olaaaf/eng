...
inline void CPU6502::setZero(bool val) { setSRFlag(StatusFlags::ZERO, val); }

inline void CPU6502::setCarry(bool val) { setSRFlag(StatusFlags::CARRY, val); }
...
void CPU6502::ADC(std::function<u16()> addressing) { ADC(read(addressing())); }
...
void CPU6502::AND(std::function<u16()> addressing) { AND(read(addressing())); }
...
void CPU6502::CMP(std::function<u16()> addressing) { CMP(read(addressing())); }
...
void CPU6502::EOR(std::function<u16()> addressing) { EOR(read(addressing())); }
...
void CPU6502::LDA(std::function<u16()> addressing) { LDA(read(addressing())); }
...
void CPU6502::LDX(std::function<u16()> addressing) { LDX(read(addressing())); }
...
void CPU6502::ORA(std::function<u16()> addressing) { ORA(read(addressing())); }
...
void CPU6502::SBC(std::function<u16()> addressing) { SBC(read(addressing())); }

void CPU6502::SBC(u8 data) { ADC(data ^ 0xFF); }
